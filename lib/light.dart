...
class _ViewDetailsState extends State<light> {
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/light_sys.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Light Irrigation System ON !!!'),
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          _writeData('light', 'off');

                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content:
                                  Text('Light Irrigation System OFF !!!'),
                              duration: Duration(seconds: 2),
                            ),
                          );
                        },
