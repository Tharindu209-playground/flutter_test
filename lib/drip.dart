...
class _ViewDetailsState extends State<drip> {
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/dri.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          ),
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Drip Irrigation System ON !!!'),
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Drip Irrigation System OFF !!!'),
                              duration: Duration(seconds: 2),
                            ),
                          );
                        },
