...
class _ViewDetailsState extends State<Exhaust> {
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/exhaust.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: () {
                          _writeData('exhust', 'on');
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Exhaust Irrigation System ON !!!'),
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          _writeData('exhust', 'off');

                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content:
                                  Text('Exhaust Irrigation System OFF !!!'),
                              duration: Duration(seconds: 2),
                            ),
                          );
                        },
